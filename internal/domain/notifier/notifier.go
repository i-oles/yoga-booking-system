...
type INotifier interface {
	NotifyPassActivation(email string, passID int, passSlots []models.PassSlot) error
	...
	NotifyClassUpdate(params models.NotifierParams, msg, cancellationLink string) error
